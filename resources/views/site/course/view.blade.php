        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <div class="course-image mt-2">
                        <img src="@if(!is_null($course->course_image) && Storage::exists($course->course_image)){{ asset('storage/'.$course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif">
                    </div>
                ...
                <section class="course_preview_video mt-3">
                    <div class="aligncenter overlay">
                        ...
                        <video controls id="myVideo" style="display:none;">
						    <source src="{{ asset('storage/'.$file_name) }}" type="video/mp4">
						    Your browser doesn't support HTML5 video tag.
						</video>
                        <img src="@if(Storage::exists($file_image_name)){{ asset('storage/'.$file_image_name) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif" alt="image description">
                    </div>
                </section>
                @endif
