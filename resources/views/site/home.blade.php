                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="course-block mx-auto">
                            <a href="{{ route('course.view', $course->course_slug) }}">
                                <main>
                                    <img src="@if(!is_null($course->thumb_image) && Storage::exists($course->thumb_image)){{ asset('storage/'.$course->thumb_image) }}@else{{ asset('backend/assets/images/user_thumbnail.png') }}@endif">
