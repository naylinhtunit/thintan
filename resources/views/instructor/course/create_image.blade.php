        ...
        <div class="form-group col-md-6">
            ...
            <label class="cabinet center-block">
                <figure class="course-image-container">
                    ...
                    <img src="@if(!is_null($course->course_image) && Storage::exists($course->course_image)){{ Storage::url($course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif" class="gambar img-responsive" id="course_image-output" name="course_image-output" />
                </figure>
            </label>
        </div>
...
<script type="text/javascript">
    ...
    { 
        //image crop start
        $(".gambar").attr("src", @if(!is_null($course->course_image) && Storage::exists($course->course_image))"{{ asset('storage/'.$course->course_image) }}" @else "{{ asset('backend/assets/images/course_detail.jpg') }}" @endif);
